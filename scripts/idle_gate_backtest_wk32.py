#!/usr/bin/env python3
"""MOVEMENT 2 (week ending 2026-08-07) — THE IDLE-GATE LAB.
...
vetoes stripped) at the 54 FROZEN sat-out runs of the Movement-1 census, IN-DIRECTION,
...
time-of-day segmentation per the backtest-discipline rule, and per-regime R sweeps.
  ...
  PYTHONPATH=src .venv/bin/python scripts/idle_gate_backtest_wk32.py
"""
...
GATES = [
    ...
    ("grind_long",        "grind",        "LONG",  dict(slope_min=0.4, fast_slope=True, ext_hi=2.0), (2.5, "wide")),
...
ATR_FLOOR_LIVE = {"grind_long": 10.0, "capitulation_long": 10.0}   # deciders.ATR_FLOOR
...
def main():
    ...
    with open("/home/alphabot/gazbot7/reports/friday_v7/sections/movement2_wk32.json", "w") as fh:
        json.dump(out, fh, indent=1, default=str)
    print("\nJSON -> reports/friday_v7/sections/movement2_wk32.json")
