...
PHASES = [
    ...
    *[dict(key=f"gf_{cl}", artifact=f"{SEC}/gf_full_{cl}.md", deps=[], timeout_s=10800, prompt=PRE +
    ...
    dict(key="gf_report", artifact=f"{WEB}/gates_{WEEK_TODAY}.html", deps=["gf_RIDER_ALL", "gf_UNCLASS", "gf_OPEN-NEWS", "gf_VACUUM", "gf_FLOW-LED", "gf_chopscalp", "gf_MGC"],
         ...
         f"tr.row-hl / tr.row-bad, span.tag verdict pills) to {WEB}/gates_{WEEK_TODAY}.html. It MUST "
