...
ER_FLOOR = {"abs_veto_long": 0.35, "grind_long": 0.35}  # ★2026-07-30 (operator): momentum-long ER floor RAISED to 0.35 — "very strong confirmed trends only". Grounded in the 07-30 rotation day: momentum longs bucketed by 30-min entry-ER were −$431 @18%W in the MID band 0.20-0.35 (rotation legs that look trendy but reverse), vs +$279 @40%W at ER≥0.35. So the floor now excludes the mid-zone bleed. ⚠ REVERSES the 07-25 grind rehab (which DROPPED grind's floor, arguing "runners & false-starts share ER 0.14, ATR is the lever") — that was a trend-week finding; this is a rotation-day finding. N=1, NEEDS a multi-regime backtest (scripts) before trusting. ⚠ abs_veto's 55s absorption-veto already filters fakes, so 0.35 may over-filter its good early thrusts — a lower abs_veto floor is a tuning refinement to test. [prev: abs_veto_long 0.20, grind_long none].
